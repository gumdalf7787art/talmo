...
export default function PCHeader() {
  ...
  const navItems = [
    { href: "/", label: "?? },
    { href: "/community", label: "Ïª§Î??àÌã∞" },
    { href: "/diagnosis", label: "AI Î∂ÑÏÑù" },
    { href: "/consult", label: "1:1 ?ÅÎã¥" },
  ];
      ...
      <div className="max-w-[1080px] mx-auto flex items-center justify-between px-6 h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="text-sm">Í≤Ä??/span>
          </Link>
          ...
          {mounted && isLoggedIn ? (
            <>
              ...
              >
                ...
                <span className="text-sm font-medium">ÎßàÏù¥?òÏù¥ÏßÄ</span>
              </Link>
            </>
          ) : mounted && !isLoggedIn ? (
            <Link
