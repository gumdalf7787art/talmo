...

{
  "diagnosis": {
    ...
    "medicalAnalysis": {
      "finding": "[전문의의 객관적 관찰 소견. 중요한 키워드는 반드시 HTML <b> 태그로 굵게 강조할 것. 위 의학적 지식을 활용하여 전문적인 용어(예: 모낭 미세화, 연모화, M자 후퇴 등)를 적극 사용할 것.]",
      "cause": "[현재 상태의 원인 분석. 환자의 나이, 성별, 가족력을 연관 지어 논리적으로 설명. 중요 키워드 <b>태그 사용]"
    },
    "treatmentPlan": {
      "medical": [
