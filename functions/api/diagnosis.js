...

{
  "diagnosis": {
    ...
    "treatmentPlan": {
      "medical": [
        "[의학적 상담 권고사항 1. (🚨경고: 피나스테리드, 두타스테리드 등 전문의약품 성분명 및 제품명을 절대 직접 언급하지 마세요. 대신 '남성형 탈모 완화를 위한 의학적 치료(경구약 복용 등)에 대해 피부과 전문의 상담 권장'과 같은 방식으로 우회하여 작성할 것.)]",
        "[의학적 상담 권고사항 2. (의료행위나 약물 처방을 유도하는 표현 금지)]"
      ],
      "homeCare": [
